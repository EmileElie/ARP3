...
<div class="account-create">
  <form id="mtarget-account-create"
        ...
        action="{$url_config|escape:'htmlall':'UTF-8'}&action=configuration"
        method="post"
    ...
    <div class="panel">
        ...
        <div class="form-group">
          ...
          <div class="col-lg-6">
            <input type="text"
                   name="account_email"
                   id="account_email"
                   value="{if isset($smarty.post.account_email)}{$smarty.post.account_email|escape:'htmlall':'UTF-8'}{else}{$current_user.email}{/if}">
          </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="col-lg-6">
            <input type="password" name="account_password" id="account_password"
                   value="{if isset($smarty.post.account_password)}{$smarty.post.account_password|escape:'htmlall':'UTF-8'}{/if}">
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="col-lg-6">
            <input type="text"
                   ...
                   id="account_lastname"
                   value="{if isset($smarty.post.account_lastname)}{$smarty.post.account_lastname|escape:'htmlall':'UTF-8'}{else}{$current_user.lastname}{/if}">
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="col-lg-6">
            <input type="text"
                   ...
                   value="{if isset($smarty.post.account_firstname)}{$smarty.post.account_firstname|escape:'htmlall':'UTF-8'}{else}{$current_user.firstname}{/if}">
          </div>
        </div>
        <div class="form-group">
      ...
      <input type="hidden" name="submitMtargetRegistration">
...
<script>
  function onloadCallback(){
    ...
    widgetReCaptcha = grecaptcha.render("recaptchamtg",{
      'sitekey': '6Lf1ijgUAAAAAGzQj48tOOjLLGCXBM5CPWdD7P2G',
      'size': 'invisible',
  ...
  function submitForm(){
    $('#mtarget-account-create').submit();
  }

  $(document).ready(function() {

    $('#mtarget-submit-account').on('click', function(e){
      e.preventDefault();
