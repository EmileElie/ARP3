...
<form id="mtarget-update-status"
      ...
      action="{$url_config|escape:'htmlall':'UTF-8'}"
      method="post"
      enctype="multipart/form-data">
  <input type="hidden" name="submitMtargetUpdateStatus" value="1">
  <div class="panel">
    <div class="enabled-sms"><span>{$enable_sms|escape:'htmlall':'utf-8'}</span> {l s='enabled SMS' mod='mtarget'}</div>
    <div class="disabled-sms"><span>{$disable_sms|escape:'htmlall':'utf-8'}</span> {l s='disabled SMS' mod='mtarget'}</div>
