  ...
  <div class="col-lg-12 footer">
    <div class="col-lg-3 footer-block">
      ...
      <div class="block-content">
        ...
        <a href="{$url_config|escape:'htmlall':'utf-8'}&action=sms">{l s='SMS Automated' mod='mtarget'}</a></div>
    </div>
    <div class="col-lg-3 footer-block">
      ...
      <div class="block-content">
        ...
        <a href="{$url_config|escape:'htmlall':'utf-8'}&action=marketing">{l s='SMS Marketing' mod='mtarget'}</a></div>
    </div>
    <div class="col-lg-3 footer-block">
